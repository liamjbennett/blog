...
Skip ahead five years, and there wasn't a company that didn't have some form of public cloud deployment, some with a multi-cloud configuration and many new companies who had never been deployed anywhere else. Public cloud adoption became mainstream, and the laggards’ voices faded into the background.
