...
* Tuesday was a workshop in Gloucester to launch a new internal project (here to referred to as Project-N) with a focus on software lifecycle management. Our customers are an ever evolving landscape of new operating systems, function code and PaaS engine versions - ensuring we're always on-top of these is key to offering a pro-active managed service.
