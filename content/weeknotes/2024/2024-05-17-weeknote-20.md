...
More customers, more deals. Still surprising that after all these years there are still folks out there who haven't migrated to the cloud yet. There are also so many organisations that find themselves adrift for support when a bad exit from an exiting outsource provider occurs. This is my in [my 7 powers blog post this month](https://www.liamjbennett.me/posts/2024-05-15-7-powers-for-msps/) I still think customer experience is a massive problem in our industry and one that can be a competitive advantage.
